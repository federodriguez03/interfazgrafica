...
public class ABMPerro implements IABMMascota{
    ...
    public void modificacionMascota(Mascota mascota) {
        ...
        // Verifica si la mascota ya existe en la base de datos mediante su código
        if (iDaoPerro.buscarPerroPorCodigo(perro.getCodigoPerro()) != null) {
            // Si existe, procede a realizar la modificación
            if (iDaoPerro.actualizarPerro(perro) == 1) {
                System.out.println("La mascota se actualizó correctamente");
            } else {
                System.out.println("Error al intentar actualizar los datos de la mascota");
            }
        } else {
            System.out.println("No se encontró una mascota con el código especificado para modificar");
        }
    } else {
        System.out.println("El objeto mascota no puede ser nulo");
    }
    }
    ...
    @Override
    public Mascota buscarMascota(String codigoMascota) {
        /*
        Perro p = new Perro();
        ...
        */
       Mascota mascota = iDaoPerro.buscarPerroPorCodigo(codigoMascota);
    
    if (mascota != null) {
        System.out.println("La mascota fue encontrada: " + mascota);
    } else {
        System.out.println("No existe una mascota con el código especificado");
    }
