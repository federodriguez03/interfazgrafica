...
public class Menu {
    ...
    private static void subMenuVeterinario(){
        System.out.println("========================== SUB MENU ABM VETERINARIO ========================");
    ...
    // Caso 2
    private static void bajaDuenio()throws DuenioException{
        Scanner scan= new Scanner(System.in);
    ...
    private static void modificarDatosPerro(){
        Scanner scan= new Scanner(System.in);
        System.out.println("Ingrese el còdigo de la mascota a modificar");
        String codigo=scan.nextLine();
        ...
        String raza=scan.nextLine();
        p.setRaza(raza);
        ambPerro.modificacionMascota(p);
        }else
    ...
    private static void altaDeMascota(){
        ...
        int dni=scan.nextInt();
        System.out.println("Ingrese 1 si la mascota es perro o 2 si es gato.");
